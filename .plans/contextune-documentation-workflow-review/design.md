...
implementation:
  ...
  phases:
    - phase: 1
      ...
      validation:
        ["Read ctx-execute.md", "Verify Step 1 is extraction, not file check"]
    ...
    - phase: 5
      ...
      tasks:
        [
          "Grep all commands for 'time', 'hours', 'minutes'",
          "Verify CLAUDE.md token section is referenced",
        ]
      validation:
        ["No estimation violations found", "Token approach consistently used"]
```
