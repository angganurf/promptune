...
1. Verify status files written correctly
1. Verify batch update creates all comments
1. Verify issues closed correctly
...
1. Verify PRs created correctly
1. Verify PRs link to issues
